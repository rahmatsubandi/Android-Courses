...
import com.example.mapsapp.network.ApiServices;
import com.example.mapsapp.network.InitLibrary;
import com.example.mapsapp.response.Distance;
import com.example.mapsapp.response.Duration;
import com.example.mapsapp.response.LegsItem;
...
public class OjekActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private String API_KEY = "AIzaSyBkYOrmKL31HcFDRofeFEsGpPWpPkrx2uM";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Ojek Online Kayanya");
